 ...
 */
final class Version20240119161358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD player1_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE game ADD player2_id INT DEFAULT NULL');
